...
- Hostinger SMTP verification email.
...
Do not use old PostgreSQL runtime variables, legacy production-host assumptions, or Firebase Storage as the new upload provider for this deploy repo.
